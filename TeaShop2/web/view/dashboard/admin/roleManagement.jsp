                    ...
                    <main>
                        <div style="margin-top: 20px" class="container-fluid px-4">                           
                            ...
                            <div style="margin-left: 15px; margin-bottom: 20px; margin-top: 20px">
                                <a href="addrole"><button type="button" class="btn btn-danger">Thêm Role</button> </a>
                            </div>
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <c:forEach items="${listRole}" var="lr">
                                                <tr>                                                 
                                                    <td>${lr.role_id}</td>
                                                    <td>${lr.role_name}</td>                                                   
                                                    <td><a href="editRole?id=${lr.role_id}">Edit</a>
                                                        <a href="deleterole?id=${lr.role_id}">Delete</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
