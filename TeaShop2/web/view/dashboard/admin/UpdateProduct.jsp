                                        ...
                                        <table id="datatables-UpdateProduct">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file" name="image_url" size="30" style="height: 35px"/>
                                                    </td>
                                                    <td>
                                                        <input type="number" name="price" size="15" style="height: 35px" value="${param.price != null ? param.price : productUpdate.price}"/>
                                                    </td>
                                                    <td>
