<%-- 
    ...
    Created on : Jun 20, 2024, 9:04:11 PM
    Author     : Huyen Tranq
--%>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content">
                    <form id="switchForm"  action="editcustomer" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <fieldset>
                            <!-- Form Name -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="input-like-p" name="role">
                                                                ...
                                                                <option value="2" ${'User' eq acc.role_name ? "selected" : ""}>Customer</option>                                                         
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9" style="display: flex">                                                           
                                                            <select class="input-like-p" name="status">
                                                                ...
                                                                <option value="2" ${'Deactive' eq acc.status_name ? "selected" : ""}>Deactive</option>   
                                                            </select>
